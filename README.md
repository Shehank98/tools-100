...
**Public site**
- Homepage: hero, prominent search, category grid, trending + recently-added
...
# 3. create schema + seed (10 categories, 50 real tools, admin user)
...
> Migrations also run automatically on boot (idempotent). Set
> `SKIP_MIGRATIONS=true` to disable that.
...
1. Have real content live (this seed ships 50 real tools + working search ✅).
